...
UNIMP_DECL (PragmaCommentDecl)
UNIMP_DECL (OMPCapturedExprDecl)
UNIMP_DECL (OMPDeclareReductionDecl)
UNIMP_DECL (CXXInheritedCtorInitExpr)
UNIMP_DECL (OMPTargetUpdateDirective)
UNIMP_DECL (PragmaDetectMismatchDecl)
UNIMP_DECL (ConstructorUsingShadowDecl)
UNIMP_DECL (OMPDistributeSimdDirective)
UNIMP_DECL (OMPTargetExitDataDirective)
UNIMP_DECL (OMPTargetParallelDirective)
UNIMP_DECL (OMPTargetEnterDataDirective)
UNIMP_DECL (OMPTargetParallelForDirective)
UNIMP_DECL (OMPDistributeParallelForDirective)
