...
let string_of_builtin_type = function
  ...
  | BT_OCLImage1dRO -> "oclimage1dro"
  | BT_OCLImage1dWO -> "oclimage1dwo"
  | BT_OCLImage1dRW -> "oclimage1drw"
  | BT_OCLImage1dArrayRO -> "oclimage1darrayro"
  | BT_OCLImage1dArrayWO -> "oclimage1darraywo"
  | BT_OCLImage1dArrayRW -> "oclimage1darrayrw"
  | BT_OCLImage1dBufferRO -> "oclimage1dbufferro"
  | BT_OCLImage1dBufferWO -> "oclimage1dbufferwo"
  | BT_OCLImage1dBufferRW -> "oclimage1dbufferrw"
  | BT_OCLImage2dRO -> "oclimage2dro"
  | BT_OCLImage2dWO -> "oclimage2dwo"
  | BT_OCLImage2dRW -> "oclimage2drw"
  | BT_OCLImage2dArrayRO -> "oclimage2darrayro"
  | BT_OCLImage2dArrayWO -> "oclimage2darraywo"
  | BT_OCLImage2dArrayRW -> "oclimage2darrayrw"
  | BT_OCLImage2dArrayDepthRO -> "oclimage2darraydepthro"
  | BT_OCLImage2dArrayDepthWO -> "oclimage2darraydepthwo"
  | BT_OCLImage2dArrayDepthRW -> "oclimage2darraydepthrw"
  | BT_OCLImage2dArrayMSAARO -> "oclimage2darraymsaaro"
  | BT_OCLImage2dArrayMSAAWO -> "oclimage2darraymsaawo"
  | BT_OCLImage2dArrayMSAARW -> "oclimage2darraymsaarw"
  | BT_OCLImage2dArrayMSAADepthRO -> "oclimage2darraymsaadepthro"
  | BT_OCLImage2dArrayMSAADepthWO -> "oclimage2darraymsaadepthwo"
  | BT_OCLImage2dArrayMSAADepthRW -> "oclimage2darraymsaadepthrw"
  | BT_OCLImage2dDepthRO -> "oclimage2ddepthro"
  | BT_OCLImage2dDepthWO -> "oclimage2ddepthwo"
  | BT_OCLImage2dDepthRW -> "oclimage2ddepthrw"
  | BT_OCLImage2dMSAARO -> "oclimage2dmsaaro"
  | BT_OCLImage2dMSAAWO -> "oclimage2dmsaawo"
  | BT_OCLImage2dMSAARW -> "oclimage2dmsaarw"
  | BT_OCLImage2dMSAADepthRO -> "oclimage2dmsaadepthro"
  | BT_OCLImage2dMSAADepthWO -> "oclimage2dmsaadepthwo"
  | BT_OCLImage2dMSAADepthRW -> "oclimage2dmsaadepthrw"
  | BT_OCLImage3dRO -> "oclimage3dro"
  | BT_OCLImage3dWO -> "oclimage3dwo"
  | BT_OCLImage3dRW -> "oclimage3drw"
